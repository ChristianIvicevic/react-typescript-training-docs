...
<<basics-of-typescript.adoc#,Basics of Typescript>> :: Introduction to the basics of the Typescript programming language, advantages of Typescript over Javascript and the basic data types
