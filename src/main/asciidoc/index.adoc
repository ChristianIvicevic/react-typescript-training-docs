...
[horizontal]
<<about-the-training.adoc#about-the-training,About the Training>> :: General information about the training itself including the scope, requirements and details on the training material.
<<basics-of-typescript.adoc#basics-of-typescript,Basics of Typescript>> :: Introduction to the basics of the Typescript programming language, advantages of Typescript over Javascript and the basic data types
