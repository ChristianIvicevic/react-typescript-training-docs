...
* The section about <<basics-of-typescript.adoc#null-and-undefined,null and undefined>> has been reworked to better distinguish between both types and their usage. {docs-repo-issues}/5[#5]
...
* The section about <<basics-of-typescript.adoc#intersection-types,intersection types>> was violating the style guide. It has been rewritten to no longer contain sentence fragments. {docs-repo-issues}/2[#2]
